...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-20 bg-gradient-to-b from-white to-gray-50 dark:from-slate-900 dark:to-slate-800 border-r border-gray-200 dark:border-gray-700 flex flex-col items-center py-6 space-y-6 shadow-lg backdrop-blur-sm z-50">
